...
func new_response(Context Context) Response {
	ret := &WTFResponse{}
	ret.Context = Context
	return ret
}

func (resp *WTFResponse) StatusCode(code int, body ...string) {
...
func (resp *WTFResponse) NotFound(body ...string) {
	resp.StatusCode(http.StatusNotFound, body...)
}

func (resp *WTFResponse) Redirect(url string) {
	resp.Context.Header().Set("Location", url)
	resp.StatusCode(http.StatusMovedPermanently)
}

func (resp *WTFResponse) Follow(url string, body ...string) {
	resp.Context.Header().Set("Location", url)
	resp.StatusCode(http.StatusSeeOther, body...)
}

func (resp *WTFResponse) CrossOrigin(domain ...string) {
	if len(domain) > 0 {
...
func (resp *WTFResponse) WriteJson(obj interface{}) (int, error) {
...
func (resp *WTFResponse) WriteXml(obj interface{}) (int, error) {
